...
_FORMAT_INSTRUCTIONS = (
    ...
    "Every bullet point in every section MUST follow this exact format — "
    "no exceptions:\n"
    "- **Bold Label:** One to two sentences of context. "
    "[Link Text](https://source-url)\n\n"
    "Rules:\n"
    "- The label MUST be wrapped in double asterisks: **like this**\n"
    "- Use only `-` bullet points — never numbered lists (1. 2. 3.)\n"
    "- No sub-headings, no 'Why:' blocks, no 'Action:' blocks — "
    "one `-` bullet per item only\n\n"
    "Example of correct output:\n"
    "- **Patch FortiClient EMS:** CVE-2026-35616 (CVSS 9.1) is actively exploited — "
    "apply the out-of-band patch immediately. "
    "[CVE-2026-35616](https://thehackernews.com/example)\n\n"
